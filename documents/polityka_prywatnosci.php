...
<head>
    ...
    <title>Secur IT | Polityka Prywatności</title>
</head>
<body>
    <div class="tlo"></div>
    <main class="main">
        ...
        <article class="subpage-container">
            ...
            <p>Poniższa Polityka Prywatności jest integralną częścią <a href="./regulamin.php">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>
            <h2 style="text-align:center">§1 Definicje</h2>
            <ul>
                <li>
                    <p><strong>Serwis</strong> - serwis internetowy "secur-it.pl" działający pod adresem secur-it.pl</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest firma "Secur IT Dawid Mostowski", prowadząca działalność pod adresem: Heraklesa 38G, 42-221, Częstochowa, Polska, o nadanym numerze identyfikacji podatkowej (NIP): 9482256434, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Urządzenie</strong> - elektroniczne urządzenie wraz z oprogramowaniem, za pośrednictwem którego Użytkownik uzyskuje dostęp do Serwisu</p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p><strong>Cookies wewnętrzne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez system teleinformatyczny Serwisu</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis <span id="sz1" style="display: none;">lub Serwisy zewnętrzne</span> podczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.</p>
                </li> 
                <li>
            ...
            <ul id="zewnetrzne">
                <li>
                    ...
                    <ul>
                        <li>
                            <a rel="nofollow external" href="https://www.youtube.com/t/terms">YouTube</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li>
                            <a rel="nofollow external" href="https://www.facebook.com/legal/terms">Facebook</a>
                        </li>
                        <li>
                            <a rel="nofollow external" href="https://www.linkedin.com/legal/user-agreement">LinkedIn</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li>
                            <a rel="nofollow external" href="https://help.instagram.com/519522125107875">Instagram</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><a rel="nofollow external" href="https://www.ovh.pl/ochrona-danych-osobowych/">home.pl</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w Polsce. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
            <br />
            ...
            <ul>
                <li>Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. w sprawie ochrony osób fizycznych w związku z przetwarzaniem danych osobowych i w sprawie swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE (ogólne rozporządzenie o ochronie danych)
                    <ul>
                        ...
                        <li>art. 6 ust. 1 lit. c<br /><small>przetwarzanie jest niezbędne do wypełnienia obowiązku prawnego ciążącego na administratorze</small></li>
                        <li>art. 6 ust. 1 lit. e<br /><small>przetwarzanie jest niezbędne do wykonania zadania realizowanego w interesie publicznym lub w ramach sprawowania władzy publicznej powierzonej administratorowi</small></li>
            ...
            <ul>
                <li>
                    <p><strong>Adres pocztowy</strong> - Secur IT Dawid Mostowski, Heraklesa 38G, 42-221, Częstochowa, Polska</p>
                </li> 
                <li>
                    <p><strong>Adres poczty elektronicznej</strong> - <a href="mailto:contact@secur-IT.pl">contact@secur-it.pl</a></p>
                </li> 
                <li>
                    <p><strong>Połączenie telefoniczne</strong> - +48 535525904</p>
                </li> 
                <li>
                    <p><strong>Formularz kontaktowy</strong> - dostępny pod adresem: https://secur-it.pl/FO/contact.php</p>
                </li>
            </ul>
