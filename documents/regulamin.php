...
<head>
    ...
    <title>Secur IT | Regulamin</title>
</head>
<body>
    <div class="tlo"></div>
    <main class="main">
        ...
        <article class="subpage-container">
            ...
            <ul>
                ...
                <li><strong>Serwis</strong> – serwis internetowy &quot;secur-it.pl&quot;, działających pod adresem https://secur-it.pl</li>
                <li><strong>Usługodawca</strong> – firma &quot;Secur IT Dawid Mostowski&quot; z adresem siedziby: Heraklesa 38G, 42-221, Częstochowa, Polska, NIP: 9482256434</li>
            ...
            <ul>
                ...
                <li>Wymagania techniczne związane z rejestracją konta:
                    <ul>
                ...
                <li>Dodatkowe zasady bezpieczeństwa w zakresie korzystania z konta:
                    <ul>
            ...
            <h2>V. Warunki komunikacji i świadczenia pozostałych usług w Serwisie</h2>
            <ul>
                <li>Serwis udostępnia usługi i narzędzia umożliwiające Usługobiorcom interakcję z Serwisem w postaci:
                    <ul>
                        ...
                        <li>Publikowania własnych treści w postaci wpisów i artykułów</li>
                    </ul>
                </li>
                ...
                <li>W przypadku kontaktu Usługobiorcy z Usługodawcą, dane osobowe Usługobiorców będa przetwarzane zgodnie z &quot;<a href="./polityka_prywatnosci.php">Polityką Prywatności</a>&quot;, stanowiącą integralną część Regulaminu.</li>
                <li>Warunki umieszczania treści przez Usługobiorców w Serwisie:
                    <ul>
            ...
            <p>Zakres, cele, sposób oraz zasady przetwarzania danych dostępne są w załącznikach do Regulaminu: &#8222;<a href="./rodo.php">Obowiązek informacyjny RODO</a>&#8221; oraz w &#8222;<a href="./polityka_prywatnosci.php">Polityce prywatności</a>&#8222;, stanowiących integralną część Regulaminu.</p>
            <ul>
                <li><em>Dane zbierane automatycznie:</em><br>Do sprawnego działania Serwisu oraz do statystyk zbieramy automatycznie niektóre dane o Usługobiorcy. Do danych tych należą:
                    <ul>
                        <li>Adres IP</li>
                        ...
                        <li>Anonimowe dane demograficzne na podstawie danych Google Analytics:
                            <ul>
                                <li>Płeć</li>
                                <li>Wiek</li>
            ...
            <ul>
                ...
                <li>We wszelkich sprawach związanych z działalnością Serwisu należy kontaktować się z Usługodawcę korzystając z jednej z poniższych form kontaktu:
                    <ul>
                        ...
                        <li>Wysyłając wiadomość na adres e-mail: <a href="mailto:contact@secur-IT.pl">contact@secur-it.pl</a></li>
                        <li>Poprzez połączenie telefoniczne z numerem: +48 535525904</li>
                    </ul>
