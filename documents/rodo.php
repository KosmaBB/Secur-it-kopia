        ...
        <main class="main">
            ...
            <article class="subpage-container">
                ...
                <p>
                    ...
                    <a href="./polityka_prywatnosci.php">Polityce Prywatności</a>
                ...
                <p>Administratorem Danych Osobowych (dalej Administrator) jest firma "Secur IT Dawid Mostowski", prowadząca działalność pod adresem: Heraklesa 38G, 42-221, Częstochowa, Polska, o nadanym numerze identyfikacji podatkowej (NIP): 9482256434, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
                ...
                <p>Z Administratorem można skontaktować się w jeden z poniższych sposobów</p>
                    ...
                    <li>
                        <p><strong>Formularz kontaktowy</strong> - dostępny pod adresem: <a href='../FO/contact.php'>Kontakt</a></p>
                    </li>
                </ul>
                ...
                <p>Szczegółowy zakres przetwarzanych danych dostępny jest w <a href="./polityka_prywatnosci.php">Polityce Prywatności</a>.</p>
                ...
                <p>Co do zasady, wskazane dane osobowe są przechowywane wyłącznie przez okres świadczenia usługi w ramach prowadzonego serwisu przez Administratora. Są one usuwane lub anonimizowane w okresie do <strong>30 dni od chwili zakończenia świadczenia usług</strong> (np. usunięcie zarejestrowanego konta użytkownika (w przypadku zlecenia takiego działania przez użytkownika), wypisanie z listy Newsletter, itp.)</p>
