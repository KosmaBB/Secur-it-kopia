        ...
        <?php
                ...
                if ($_SESSION['loggedin'] === true) {
                    ...
                    if ($data && mysqli_num_rows($data) > 0) {
                        ...
                        echo "<a href='./change_password.php' class='button_change_password'>Zmień hasło</a>";
                        echo "<a href='./edit_account.php' class='button_edit_account'>Edytuj dane konta</a>";
                        echo "</div>";
                        
                        // Sprawdzamy, czy użytkownik należy do firmy
                        if (!empty($user['company_name'])) {
                            echo "<div class='firma_page'>";
                            ...
                            if ($user['id_company'] != 1 && $user['is_company_admin']) {
                                echo "<a href='./add_employee.php'><button>Dodaj pracownika</button></a>";
                            }
                            if ($user['is_company_admin'] == 1) {
                                echo "<a href='./view_employee.php'><button>Wyświetl pracowników</button></a>";
