                    ...
                    <?php
                        while($row = mysqli_fetch_assoc($data)) {
                            echo "<div class='service-card'>
                                    ...
                                    <div class='buttons'>
                                        <button class='modern-button delete'><a href='admin_networks.php?del=True&id_service=".$row['id_service']."' class='button-link'>Usuń usługę</a></button>
                                        <button class='modern-button'><a href='networks_edit.php?id_service=".$row['id_service']."' class='button-link'>Edytuj usługę</a></button>
                                    </div>
                                  </div>";
                        }
                    ?>
