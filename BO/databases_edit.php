...
<html lang="pl">
    <head>
        ...
        <title>Secur IT | Admin - Edytuj Bazy Danych</title>
    </head>
    <body>
        <?php
        ...
        <main class="main">
            <div class="formularz modern-form">
                <h1 class="center-text">Edytuj Bazę Danych</h1>
                <?php
                    ...
                    if(!empty($_GET)){                
                        ...
                        if (!empty($data)){
                            ...
                            {
                                echo "<form class='form-add-service' action='./admin_databases.php' method='get'>
