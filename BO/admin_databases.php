...
<head>
    ...
    <title>Secur IT | Admin - Bazy Danych</title>
</head>
<body>
    <div class="tlo"></div>
    <main class="main">
                    ...
                    <?php
                        while($row = mysqli_fetch_assoc($data)) {
                            echo "<div class='service-card'>
                                    ...
                                    <div class='buttons'>
                                        <button class='modern-button delete'><a href='admin_databases.php?del=True&id_service=".$row['id_service']."' class='button-link'>Usuń usługę</a></button>
                                        <button class='modern-button'><a href='databases_edit.php?id_service=".$row['id_service']."' class='button-link'>Edytuj usługę</a></button>
                                    </div>
                                  </div>";
                        }
                    ?>
